...
export function LandingPage() {
  ...
  const textContent: { es: LanguageContent; en: LanguageContent } = {
    es: {
      ...
      download: "EmpowerAr es una herramienta abierta pensada para acompañar a familias rurales en su camino hacia la energía limpia. Desde acá podés descargar todo el desarrollo: el software, el manual y los sensores que usamos. Si sos parte de una comunidad, una organización o simplemente querés ayudar, te invitamos a usarlo, mejorarlo y compartirlo. ¡La energía es un derecho, y entre todos la hacemos posible!",
    ...
    en: {
      ...
      download: "EmpowerAr is an open source tool designed to support rural families on their clean energy journey. You can download the entire development process here: the software, the manual, and the sensors we use. If you're part of a community, an organization, or just want to help, we invite you to use, improve, and share it. Energy is a right, and together we make it possible!",
