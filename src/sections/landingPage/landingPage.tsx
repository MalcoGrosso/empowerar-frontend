...
export function LandingPage() {
  ...
  const textContent: { es: LanguageContent; en: LanguageContent } = {
    es: {
      ...
      missionContent1: (
        <>
          <strong>EmpowerAr</strong> emerge de la integración sostenible y universal de la
          tecnología en la sociedad, respetando y promoviendo el bienestar humano y el progreso
          social.
        </>
      ),
      missionContent2:
        'Esta plataforma abierta, desarrollada por el LabTA, se concibió para acompañar a las familias en la gestión eficiente y sustentable de servicios esenciales como la electricidad e internet. El LabTA cuenta con experiencia en el desarrollo de modelos de negocio en comunidades rurales de Argentina.',
      missionContent3: (
        <>
          Nos sentimos profundamente orgullosos del equipo que hemos formado, cuyo rol resulta
          fundamental a través de políticas de responsabilidad social.
        </>
      ),
      stats: [
      ...
      buttonText: 'Comenzar',
      familyNeed:
        'Las familias o comunidades plantean la necesidad de acceso a energía eléctrica y bombeo de agua. Una organización (ONG, cooperativa, Asociación Civil) debe validar a la familia y ser la responsable del sistema instalado.',
      crowdfunding:
        'A través de donaciones e inversiones, la plataforma se encarga de recaudar fondos para adquirir el equipamiento necesario para los sistemas fotovoltaicos. Dependiendo de las necesidades y la capacidad de pago, las familias pueden elegir entre 4 kits fotovoltaicos de diferente potencia.',
      implementation:
        'Los fondos se utilizan para compra e instalación del equipamiento, además de crear un fondo de reserva para reparaciones.',
      tokenization: (
        <>
          <strong>EmpowerAr</strong> es una plataforma que permite a las familias gestionar sus
          pagos mensuales, reclamos y coordinar las visitas de mantenimiento. Adicionalmente, brinda
          la posibilidad de financiar la renovación de baterías.
        </>
      ),
      download:
        'EmpowerAr es una herramienta abierta pensada para acompañar a familias rurales en su camino hacia la energía limpia. Desde acá podés descargar todo el desarrollo: el software, el manual y los sensores que usamos. Si sos parte de una comunidad, una organización o simplemente querés ayudar, te invitamos a usarlo, mejorarlo y compartirlo. ¡La energía es un derecho, y entre todos la hacemos posible!',
      downloadButton: 'Descargar',
      aboutUs: (
        <>
          De la Academia al Emprendimiento. Somos un equipo que lleva casi 10 años trabajando en
          electrificación rural desde LabTA, para escalar nuestros proyectos nos dimos cuenta que
          teníamos que dar el siguiente paso. <strong>empowerar</strong> es nuestra forma de
          hacerlo.
        </>
      ),
      aboutUs1:
    ...
    en: {
      ...
      missionContent1: (
        <>
          <strong>EmpowerAr</strong> emerges from the sustainable and universal integration of
          technology into society, respecting and promoting human well-being and social progress.
        </>
      ),
      missionContent2:
        'This open platform, developed by LabTA, was designed to support families in the efficient and sustainable management of essential services such as electricity and internet. LabTA has experience developing business models in rural communities in Argentina.',
      missionContent3: (
        <>
          We are deeply proud of the team we have formed, whose role is fundamental through social
      ...
      familyNeed:
        'Families or communities raise the need for access to electricity and water pumping. An organization (NGO, cooperative, Civil Association) must validate the family and be responsible for the installed system.',
      crowdfunding:
        'Through donations and investments, the platform is responsible for raising funds to acquire the necessary equipment for photovoltaic systems. Depending on needs and payment capacity, families can choose between 4 photovoltaic kits of different power.',
      implementation:
        'The funds are used for the purchase and installation of equipment, in addition to creating a reserve fund for repairs.',
      tokenization: (
        <>
          <strong>EmpowerAr</strong> is a platform that allows families to manage their monthly
          payments, claims, and schedule maintenance visits. It also offers the option to finance
          battery replacements.
        </>
      ),
      download:
        "EmpowerAr is an open source tool designed to support rural families on their clean energy journey. You can download the entire development process here: the software, the manual, and the sensors we use. If you're part of a community, an organization, or just want to help, we invite you to use, improve, and share it. Energy is a right, and together we make it possible!",
      downloadButton: 'Download',
      aboutUs: (
        <>
          From the Academy to Entrepreneurship. We are a team that has been working on rural
          electrification for almost 10 years from LabTA. To scale up our projects, we realized that
          we had to take the next step. <strong>empowerar</strong> is our way of doing it.
        </>
      ),
      aboutUs1:
  ...
  return (
    <SimpleLandingLayout>
      ...
      <section id="download">
        <Container sx={{ my: 5 }}>
          <Typography variant="h1" align="center" sx={{ mb: 2 }}>
            {language === 'es' ? 'Descargar EmpowerAr 1.0' : 'Download EmpowerAr 1.0'}
          </Typography>
      ...
      <section id="contact" style={{ backgroundColor: '#FFE7D0' }}>
        <Container sx={{ pt: 5, pb: 10 }}>
          ...
          >
            ...
            <Button
              ...
              sx={{ backgroundColor: '#E97B4A', color: 'white' }}
            >
      ...
      >
        <Typography variant="body2" sx={{ mb: 2 }}>
          <a
            href="https://www.instagram.com/labta_unsl"
            target="_blank"
            rel="noopener noreferrer"
          ...
          &nbsp;
          <a
            href="mailto:contacto@empowerar.org"
            target="_blank"
            rel="noopener noreferrer"
            style={{ textDecoration: 'none' }}
          >
